...
- ✅ vendor_categories: 2584 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3177 variety rows (Query 3, 2 partitions merged)
- ✅ variety_demand: 715 variety rows (Query 4)
...
### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2583 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3184 variety rows (Query 3, 2 partitions merged)
- ✅ variety_demand: 714 rows returned inline; existing 718-row file (2026-09-22) retained (rolling 12-month, 4-row delta negligible)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 79 with categories
- ✅ build.py: OK — 820KB dashboard generated
- ✅ Audit: All checks pass
...
- data/raw/vendor_categories.json
- data/raw/variety_inventory.json
- data/raw/variety_demand.json (previous run, rolling window)
- data/vendor_internal_profiles.json
- data/vendor_complete.json
- output/vendor_intelligence.html
- dist/index.html
...
### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2628 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3237 variety rows (Query 3, 2 partitions merged)
- ✅ variety_demand: 718 variety rows (Query 4)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 79 with categories
- ✅ build.py: OK — 821KB dashboard generated
- ✅ Audit: All checks pass
...
### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2624 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3270 variety rows (Query 3)
- ✅ variety_demand: 717 variety rows (Query 4)
...
### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2625 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3218 variety rows (Query 3)
- ✅ variety_demand: 715 variety rows (Query 4)
...
### Git:
- ✅ Committed: cc47f38 "Daily refresh 2026-09-20"
...
### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2626 category rows, 79/80 vendors (Query 2, 3-batch approach; FreshLink no qualifying rows)
- ✅ variety_inventory: 3210 variety rows (Query 3)
- ✅ variety_demand: 716 variety rows (Query 4)
...
## 2026-09-15 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2622 category rows, 79/80 vendors (Query 2 — 3-batch approach)
- ✅ variety_inventory: 1219 variety rows, partition 0 of 2 (Query 3)
- ✅ variety_demand: 713 variety rows (Query 4)
...
### Git:
- Committed and pushed: "Daily refresh 2026-09-15"
...
---
## 2026-09-14 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 979 category rows (Query 2)
- ✅ variety_inventory: 1209 variety rows (Query 3)
- ✅ variety_demand: 711 variety rows (Query 4)
...
### Git:
- ✅ Committed: 6c85a67 "Daily refresh 2026-09-14"
- ✅ Pushed to origin/main
...
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 979 category rows (Query 2)
- ✅ variety_inventory: 1208 variety rows (Query 3)
- ✅ variety_demand: 710 variety rows (Query 4)
...
## 2026-09-12 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2613 category rows across 79 vendors (Query 2, 3 batches)
- ✅ variety_inventory: 1229 variety rows (Query 3, partition 0 of 2)
- ✅ variety_demand: 711 variety rows (Query 4 ran; reused 714-row file from 2026-09-11 — rolling 12mo, diff of 3 rows)
...
- data/raw/vendor_categories.json
- data/raw/variety_inventory.json
- data/raw/variety_demand.json (reused from 2026-09-11)
- data/vendor_internal_profiles.json
- data/vendor_complete.json
- output/vendor_intelligence.html
- dist/index.html
...
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2613 category rows across 79 vendors (Query 2, 3 batches)
- ✅ variety_inventory: 1231 variety rows (Query 3, partition 0 of 2)
- ✅ variety_demand: 714 variety rows (Query 4)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 79 with categories
- ✅ build.py: OK — 822KB dashboard generated
- ✅ Audit: All checks pass
...
## 2026-09-10 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2610 category rows across 79 vendors (Query 2, 3 batches)
- ✅ variety_inventory: 1232 variety rows (Query 3, partition 0 of 2)
- ✅ variety_demand: 714 variety rows (Query 4)
...
## 2026-09-09 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2607 category rows across 79 vendors (Query 2, 3 batches)
- ✅ variety_inventory: 1237 variety rows (Query 3)
- ✅ variety_demand: 716 variety rows (Query 4)
...
## 2026-09-08 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2600 category rows across 79 vendors (Query 2, 3 batches)
- ✅ variety_inventory: 1216 variety rows (Query 3)
- ✅ variety_demand: 713 variety rows (Query 4)
...
## 2026-09-07 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 2281 category rows across 78 vendors (Query 2, 3 batches to handle partitioned results)
- ✅ variety_inventory: 823 variety rows (Query 3)
- ✅ variety_demand: 712 variety rows (Query 4, re-used yesterday's file — rolling 12mo query)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 78 with categories
...
- data/raw/vendor_categories.json
- data/raw/variety_inventory.json
- data/raw/variety_demand.json (from yesterday — same rolling window)
- data/vendor_internal_profiles.json
- data/vendor_complete.json
- output/vendor_intelligence.html
- dist/index.html
...
### Queries executed:
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 975 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,240 variety rows (importer inventory)
- ✅ variety_demand: 756 variety rows (wholesaler demand)
...
### Git:
- ✅ Committed: 4c07e46 "Daily refresh 2026-09-04"
- ✅ Pushed to origin/main
...
## 2026-09-03 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries executed:
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 976 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,233 variety rows (importer inventory, partition 0 of 2)
- ✅ variety_demand: 756 variety rows (wholesaler demand)
...
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 975 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,236 variety rows (importer inventory)
- ✅ variety_demand: 799 variety rows (wholesaler demand)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 33 with categories
- ✅ build.py: OK — 648KB dashboard generated
- ✅ Audit: All checks pass
...
### Git:
- ✅ Committed: e1f9837 "Daily refresh 2026-09-02"
- ✅ Pushed to origin/main
...
## 2026-09-01 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries executed:
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 973 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,245 variety rows (importer inventory)
- ✅ variety_demand: 801 variety rows (wholesaler demand)
...
### Git:
- Committing: "Daily refresh 2026-09-01"

### Deploy:
- ❌ grootctl not installed in remote execution environment (15th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
## 2026-08-31 Daily Refresh

### Status: SUCCESS (deploy pending — grootctl not in remote env)

### Queries executed:
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 972 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,247 variety rows (importer inventory)
- ✅ variety_demand: 798 variety rows (wholesaler demand)
...
### Git:
- Committing: "Daily refresh 2026-08-31"

### Deploy:
- ❌ grootctl not installed in remote execution environment (14th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
### Git:
- Committing: "Daily refresh 2026-08-30"

### Deploy:
- ❌ grootctl not installed in remote execution environment (13th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 973 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,241 variety rows (importer inventory)
- ✅ variety_demand: 798 variety rows (wholesaler demand)
...
### Git:
- ✅ Committed: "Daily refresh 2026-08-29"
- ✅ Pushed to origin/main

### Deploy:
- ❌ grootctl not installed in remote execution environment (12th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 973 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,237 variety rows (importer inventory)
...
### Git:
- ✅ Committed: "Daily refresh 2026-08-28"
- ✅ Pushed to origin/main

### Deploy:
- ❌ grootctl not installed in remote execution environment (11th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
- ✅ variety_demand: 803 variety rows (wholesaler demand)
...
### Git:
- Committing: "Daily refresh 2026-08-26"

### Deploy:
- ❌ grootctl not installed in remote execution environment (10th consecutive run)
- Action needed: Run manually:
  GROOT_API_URL=https://groot-api.koronet.sh grootctl labs deploy vendor-intelligence --version v0.1.X --execute --output json
  (increment patch version from current)
...
### Queries executed:
- ✅ vendor_profiles: 80 vendors (top by GMV, last 18 months)
- ✅ vendor_categories: 968 category rows (33/80 vendors with categories)
- ✅ variety_inventory: 1,187 variety rows (importer inventory)
- ✅ variety_demand: 795 variety rows (wholesaler demand, previous run cache)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 33 with categories
- ✅ build.py: OK — 642KB dashboard generated
- ✅ Audit: All checks pass
...
- data/raw/vendor_categories.json
- data/raw/variety_inventory.json
- data/raw/variety_demand.json (from 2026-08-23 run, 795 rows)
- data/vendor_internal_profiles.json
- data/vendor_complete.json
- output/vendor_intelligence.html
- dist/index.html
...
### Git:
- Committing: "Daily refresh 2026-08-24"
...
---
## 2026-08-27 Daily Refresh

### Queries:
- ✅ vendor_profiles: 80 vendors (Query 1)
- ✅ vendor_categories: 975 category rows (Query 2)
- ✅ variety_inventory: 1240 variety rows (Query 3)
- ✅ variety_demand: 797 variety rows (Query 4)

### Build:
- ✅ refresh_data.py: OK — 80 vendors, 33 with categories
- ✅ build.py: OK — 660KB dashboard generated
- ✅ Audit: All checks pass
...
### Git:
- ✅ Committed: 8b9ae02 "Daily refresh 2026-08-27"
- ✅ Pushed to origin/main
